...
def main(args, bm):
    for dataroot_subset in ['ACCAD', 'BioMotionLab_NTroje_train', 'BioMotionLab_NTroje_test', 'BMLmovi', 'CMU_train',
        ...
        if ("train" in dataroot_subset) or ("test" in dataroot_subset):
            split_file = os.path.join("data_split", dataroot_subset + ".txt")
            ...
            filepaths = [os.path.relpath(filepath, args.root_dir) for filepath in filepaths]
        ...
        for filepath in tqdm(filepaths):
            ...
            input_rotation_global_6d = rotation_global_6d[1:, [15, 20, 21], :]  # (seq-1, 3, 6)
            ...
            input_rotation_velocity_global_6d = rotation_velocity_global_6d[:, [15, 20, 21], :]  # (seq-1, 3, 6)
            ...
            hmd_position_global_full_gt_list = torch.cat(
                [
                    ...
                    position_global_full_gt_world[1:, [15, 20, 21], :].reshape(num_frames, -1),  # (seq-1, n*3)
