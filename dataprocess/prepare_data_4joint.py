...
def main(args, bm):
   # "BioMotionLab_NTroje"
    for dataroot_subset in ["CMU","MPI_HDM05","BioMotionLab_NTroje"]:
        ...
        for phase in ["train", "test"]:
            ...
            for filepath in tqdm(filepaths):
                ...
                input_rotation_global_6d = rotation_global_6d[1:, [0,15, 20, 21], :]
                ...
                hmd_position_global_full_gt_list = torch.cat(
                    [
                        ...
                        position_global_full_gt_world[1:, [0,15, 20, 21], :].reshape(
                            num_frames, -1
                        ),
                        position_global_full_gt_world[1:, [0,15, 20, 21], :].reshape(
                            num_frames, -1
                    ...
                    dim=-1,
                )###[3*rotation6d,3*rotation_vel6d,3*position,3*velocity]
