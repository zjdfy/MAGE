...
def add_refiner_model_options(parser):
    ...
    group.add_argument(
        ...
        default=2,
        type=int,
        help="Number of layers in the refiner.",
    )
    group.add_argument(
        "--refiner_hidden_dim",
        default=512,
        type=int,
        help="Hidden dimension in the refiner.",
    )
    group.add_argument(
        "--recons",
        default=0.02,
    ...
    group.add_argument(
        ...
        default=0.01,
        type=float,
        help="Forward kinematics loss weight.",
    )
    group.add_argument(
        "--hand_align",
        default=0.02,
        type=float,
        help="Hand alignment loss weight.",
    )
    group.add_argument(
        "--jitter",
        default=0.03,
        type=float,
        help="Jitter loss weight.",
    )
    group.add_argument(
        "--milestones",
        default=[15],
        type=list,
        help="Milestones for the learning rate scheduler.",
    )
    group.add_argument(
        "--gamma",
        default=0.01,
...
def add_data_options(parser):
    ...
    group.add_argument(
        "--protocol",
        default="1_small_dataset",
        choices=["1_small_dataset", "2_full_dataset", "real", "randomsplit_0"],
        type=str,
        help="Dataset protocol.",
    )
...
def train_refiner_args():
    parser = ArgumentParser()
    add_base_options(parser)
    add_data_options(parser)
    add_model_options(parser)
    add_refiner_model_options(parser)
    add_diffusion_options(parser)
    add_training_options(parser)
    add_sampling_options(parser)
    return parser.parse_args()
